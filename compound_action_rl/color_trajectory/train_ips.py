"""Train IPS-GRPO on the 4x4 color grid."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train IPS-GRPO on the 4x4 color grid.")
    ...
    print(
        f"4x4 IPS-GRPO: max_episode_steps={env.max_episode_steps}, "
