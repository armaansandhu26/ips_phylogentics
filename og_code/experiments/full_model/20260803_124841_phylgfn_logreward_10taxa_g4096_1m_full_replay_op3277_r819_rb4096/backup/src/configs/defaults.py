...
_C.GFN.TRAINING_DATA_LOADER.MAX_CPU_THREADS = 2
"""Cap PyTorch/BLAS CPU threads per process. Override with PHYLOGFN_CPU_THREADS env or --cpu-threads."""
_C.GFN.TRAINING_DATA_LOADER.EPOCHS_NUM = 100
_C.GFN.TRAINING_DATA_LOADER.FREQ_UPDATE_MODEL_WEIGHTS = 5
_C.GFN.TRAINING_DATA_LOADER.CHECKPOINT_FREQ = 1000
_C.GFN.TRAINING_DATA_LOADER.LOG_PROGRESS_FREQ = 100
...
_C.GFN.MODEL.ONLY_TRAIN_TREE_MODEL = True
_C.GFN.MODEL.FIXED_EDGE_LENGTH = 0.025
...
_C.ENV = CfgNode()
_C.ENV.SEQUENCE_TYPE = 'DNA_WITH_GAP'  # DNA DNA_WITH_GAP RNA RNA_WITH_GAP
_C.ENV.ENVIRONMENT_TYPE = 'ONE_STEP_BINARY_TREE'
_C.ENV.LOG_SCORE_SHIFT = 3600.0
