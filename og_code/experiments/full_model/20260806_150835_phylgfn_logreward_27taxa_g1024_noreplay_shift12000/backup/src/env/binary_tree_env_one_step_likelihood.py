...
class PhyloTreeReward(object):
    ...
    def __init__(self, reward_cfg, log_score_shift=3600.0):
        self.C = reward_cfg.C
        self.log_score_shift = float(log_score_shift)
    ...
    def exponential_reward(self, log_score):
        ...
        :return:
        """
        linear = (self.C + self.log_score_shift + log_score) / self.scale
...
class PhylogenticTreeEnv(nn.Module):
    ...
    def __init__(self, cfg, sequences):
        ...
        self.reward_fn = PhyloTreeReward(
            cfg.ENV.REWARD,
            log_score_shift=self.log_score_shift,
        )
