...
| File | Description |
|------|-------------|
| `rewards.npy` | `64x64` float32 reward grid |
...
```bash
python -m final.toy.build_dataset --H 64 --D 2
python -m final.toy.plot_reward --dataset /home/armaan/phylogfn/final/datasets/hypergrid_64
```
