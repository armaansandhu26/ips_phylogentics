...
| File | Description |
|------|-------------|
| `rewards.npy` | `4096x4096` float32 reward grid |
...
```bash
python -m final.toy.build_dataset --H 4096 --D 2
python -m final.toy.plot_reward --dataset /home/armaan/phylogfn/final/datasets/hypergrid_4096
```
