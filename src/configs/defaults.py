...
# Scale only the edge-model gradient that flows back into tree_model reps.
# 1.0 is the original coupled training path; 0.0 detaches edge inputs.
_C.GFN.MODEL.EDGE_REP_GRAD_ALPHA = 1.0
